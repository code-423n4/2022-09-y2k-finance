...
When using ``` forge coverage ``` tool the automated function coverage might not work as intended (not displaying all of the covered code on the testing suite as of the latest Foundry release)
